...
export default function Landing() {
  ...
  useEffect(() => {
    const fullText =
      'AI Assistant for Information, Automation & Productivity';
    ...
    >
      ...
      >
        <div style={{ maxWidth: 1100 }}>
          ...
          >
            ⚡ AI-Powered Productivity & Business Advisory
          </div>
          ...
          >
            ReuNexus is an AI assistant that helps users find information,
            automate tasks, generate content, and improve productivity from a
            single workspace.
          </p>
          ...
          >
            <button
              ...
              aria-label="Launch ReuNexus Application"
            >
              🚀 Launch ReuNexus
            </button>
          ...
          >
            ...
            <StatCard title="Fast" subtitle="AI Responses" />
            <StatCard title="Secure" subtitle="Protected Data" />
...
// Keep your existing FeatureCard, StatCard,
// navButton, launchButton,
// heroPrimaryButton,
// heroSecondaryButton,
// and all other styles/components unchanged.